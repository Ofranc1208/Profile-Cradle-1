...
// Commented out the line that disables right-click
...
function checkForWrapping() {
    ...
    // Select elements to watch (consider if you need to target specific elements)
...
function isElementWrapping(element) {
    // Consider alternative ways to check for wrapping if needed
...
// Check for wrapping on window resize (consider debouncing for performance)
